      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <img src={img} alt="Medallion Engineers" className="h-12 w-auto" />
            <div className="text-xl font-bold text-gray-800">Medallion Engineers</div>
          </div>
          ...
          >
            ...
            >
              <p className="text-xl md:text-2xl text-blue-100 leading-relaxed">
                ...
                tunnel engineering, and comprehensive project management solutions.
              </p>
              
              <div className="text-left max-w-4xl mx-auto text-gray-200 space-y-4 text-base md:text-lg leading-relaxed">
                <p>
                  Founded in 2025, Medallion Engineers Private Limited has established itself as a leading 
                ...
                <p>
                  With our headquarters in Delhi and presence across major cities in India, we are delivering 
                  projects across various sectors including transportation, urban development, water infrastructure, 
                  and industrial facilities.
                </p>
                
                <p>
                  Our team of over 20 highly qualified engineers and specialists brings together expertise in 
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive engineering solutions across multiple disciplines and sectors
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Complex engineering solutions for transportation, urban development, and industrial facilities with focus on sustainability and innovation.",
                icon: "🏗️"
              },
              {
                title: "Tunnel Engineering",
                description: "Specialized expertise in underground construction, tunnel systems, and subsurface infrastructure with advanced technology.",
                icon: "🚇"
              },
              {
                title: "Project Management",
                description: "End-to-end project delivery with quality assurance, timeline management, and comprehensive oversight across all phases.",
                icon: "📋"
              }
            ].map((service, index) => (
              <motion.div
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">+91 99999 99999</p>
