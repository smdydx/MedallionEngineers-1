        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              >
                Medallion Engineers
                <span className="block text-blue-600">Private Limited</span>
              </motion.h1>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  description: "Team of qualified engineers across multiple disciplines"
                }
              ].map((feature, index) => (
                <motion.div
                  key={feature.title}
            ...
            >
              ...
              <Button
                onClick={handleEmail}
                variant="outline"
                className="border-gray-300 text-gray-700 hover:bg-gray-50 px-8 py-4 text-lg font-semibold rounded-xl transition-all duration-300"
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <div className="text-gray-600 text-sm">Engineers</div>
                    </div>
                  </div>
                </div>
              </motion.div>
